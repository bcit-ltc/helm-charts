...
| assets.ref | string | `"ghcr.io/bcit-ltc/legacy-soc-royaloak-assets"` | Reference to the asset OCI image |
...
| global.name | string | `"legacy-soc-royaloak"` | Authoritative name |
...
| initContainer.image.repository | string | `"bcit-ltc/legacy-soc-royaloak"` | initContainer image repository |
