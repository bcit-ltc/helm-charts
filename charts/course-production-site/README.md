...
| frontend.image.repository | string | `"bcit-ltc/course-production-site"` | Image default repository |
| frontend.image.tag | string | `"1.0.1-rc.00f4c4a.20251015064458"` | Image default tag |
...
| global.name | string | `"course-production-site"` | Authoritative name |
