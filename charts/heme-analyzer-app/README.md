...
**Homepage:** <https://heme-analyzer-app.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/heme-analyzer-app/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/heme-analyzer-app --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install heme-analyzer-app .
    ```
...
| frontend.image.repository | string | `"bcit-ltc/heme-analyzer-app"` | Frontend image repository |
...
| frontend.name | string | `"heme-analyzer-app"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"heme-analyzer-app"` | Authoritative name |
