...
legacy-multimedia is a legacy multimedia application.

**Homepage:** <https://legacy-multimedia.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/legacy-multimedia/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/legacy-multimedia --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install legacy-multimedia .
    ```
...
| assets.ref | string | `"ghcr.io/bcit-ltc/legacy-multimedia-assets"` | Reference to the asset OCI image |
...
| frontend.image.repository | string | `"bcit-ltc/legacy-multimedia"` | Frontend image repository |
...
| frontend.name | string | `"legacy-multimedia"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"legacy-multimedia"` | Authoritative name |
...
| initContainer.image.repository | string | `"bcit-ltc/legacy-multimedia"` | initContainer image repository |
