...
legacy-ltc is a legacy multimedia application.

**Homepage:** <https://legacy-ltc.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/legacy-ltc/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/legacy-ltc --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install legacy-ltc .
    ```
...
| assets.ref | string | `"ghcr.io/bcit-ltc/legacy-ltc-assets"` | Reference to the asset OCI image |
...
| frontend.image.repository | string | `"bcit-ltc/legacy-ltc"` | Frontend image repository |
| frontend.image.tag | string | `"1.0.3"` | Frontend image tag |
...
| frontend.name | string | `"legacy-ltc"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"legacy-ltc"` | Authoritative name |
...
| initContainer.image.repository | string | `"bcit-ltc/legacy-ltc"` | initContainer image repository |
| initContainer.image.tag | string | `"1.0.3"` | initContainer image tag |
