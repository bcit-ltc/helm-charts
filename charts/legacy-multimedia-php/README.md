...
legacy-multimedia-php is a legacy multimedia application.

**Homepage:** <https://legacy-multimedia-php.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/legacy-multimedia-php/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/legacy-multimedia-php --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install legacy-multimedia-php .
    ```
...
| assets.ref | string | `"ghcr.io/bcit-ltc/legacy-multimedia-php-assets"` | Reference to the asset OCI image |
...
| frontend.image.repository | string | `"bcit-ltc/legacy-multimedia-php"` | Frontend image repository |
...
| frontend.name | string | `"legacy-multimedia-php"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"legacy-multimedia-php"` | Authoritative name |
...
| initContainer.image.repository | string | `"bcit-ltc/legacy-multimedia-php"` | initContainer image repository |
| initContainer.image.tag | string | `"1.0.4"` | initContainer image tag |
