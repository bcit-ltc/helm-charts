...
**Homepage:** <https://module-estimator.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/module-estimator/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/module-estimator --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install module-estimator .
    ```
...
| global.name | string | `"module-estimator"` | Authoritative name |
