...
template-app is a legacy multimedia application.

**Homepage:** <https://template-app.ltc.bcit.ca>
...
4. List the available registry tags
        ...
        https://api.github.com/orgs/bcit-ltc/packages/container/template-app/versions \
        | jq '.[].metadata.container.tags.[]'

5. Pull and inspect the helm chart:

        helm pull --untar oci://ghcr.io/bcit-ltc/template-app --version {VERSION}

6. Install the chart:

        helm install template-app .
...
| image.repository | string | `"bcit-ltc/template-app"` |  |
