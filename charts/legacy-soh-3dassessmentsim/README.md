...
legacy-soh-3dassessmentsim is a legacy multimedia application.

**Homepage:** <https://legacy-soh-3dassessmentsim.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/legacy-soh-3dassessmentsim/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/legacy-soh-3dassessmentsim --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install legacy-soh-3dassessmentsim .
    ```
...
| assets.ref | string | `"ghcr.io/bcit-ltc/legacy-soh-3dassessmentsim-assets"` | Reference to the asset OCI image |
...
| frontend.image.repository | string | `"bcit-ltc/legacy-soh-3dassessmentsim"` | Frontend image repository |
...
| frontend.name | string | `"legacy-soh-3dassessmentsim"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"legacy-soh-3dassessmentsim"` | Authoritative name |
...
| initContainer.image.repository | string | `"bcit-ltc/legacy-soh-3dassessmentsim"` | initContainer image repository |
