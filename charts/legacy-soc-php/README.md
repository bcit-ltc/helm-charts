...
legacy-soc-php is a legacy multimedia application.

**Homepage:** <https://legacy-soc-php.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/legacy-soc-php/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/legacy-soc-php --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install legacy-soc-php .
    ```
...
| assets.ref | string | `"ghcr.io/bcit-ltc/legacy-soc-php-assets"` | Reference to the asset OCI image |
...
| frontend.image.repository | string | `"bcit-ltc/legacy-soc-php"` | Frontend image repository |
...
| frontend.name | string | `"legacy-soc-php"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"legacy-soc-php"` | Authoritative name |
...
| initContainer.image.repository | string | `"bcit-ltc/legacy-soc-php"` | initContainer image repository |
| initContainer.image.tag | string | `"1.0.15"` | initContainer image tag |
