...
| frontend.image.tag | string | `"1.0.4-rc.20251204221536.3c6b3b8"` | Frontend image tag |
...
| initContainer.image.tag | string | `"1.0.4-rc.20251204221536.3c6b3b8"` | initContainer image tag |
