...
legacy-sob-php is a legacy multimedia application.

**Homepage:** <https://legacy-sob-php.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/legacy-sob-php/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/legacy-sob-php --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install legacy-sob-php .
    ```
...
| assets.ref | string | `"ghcr.io/bcit-ltc/legacy-sob-php-assets"` | Reference to the asset OCI image |
...
| frontend.image.repository | string | `"bcit-ltc/legacy-sob-php"` | Frontend image repository |
| frontend.image.tag | string | `"1.1.1"` | Frontend image tag |
...
| frontend.name | string | `"legacy-sob-php"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"legacy-sob-php"` | Authoritative name |
...
| initContainer.image.repository | string | `"bcit-ltc/legacy-sob-php"` | initContainer image repository |
| initContainer.image.tag | string | `"1.1.1"` | initContainer image tag |
