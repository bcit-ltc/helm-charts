...
**Homepage:** <https://legacy-soc.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/legacy-soc/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/legacy-soc --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install legacy-soc .
    ```
...
| assets.ref | string | `"ghcr.io/bcit-ltc/legacy-soc-assets"` | Reference to the asset OCI image |
...
| frontend.image.tag | string | `"1.0.4-rc.20251105025347.8d8aca2"` | Frontend image tag |
...
| global.name | string | `"legacy-soc"` | Authoritative name |
...
| initContainer.image.tag | string | `"1.0.4-rc.20251105025347.8d8aca2"` | initContainer image tag |
