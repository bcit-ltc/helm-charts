# conversion-guide
conversion-guide is a reference for anyone preparing Word documents to be converted into HTML.

## Quickstart

<!-- ```bash
helm install conversion-guide ./nginx-unprivileged-app   --set image.tag=1.27-alpine   --set ingress.enabled=true   --set defaultDomain=ltc.bcit.ca
``` -->

<!-- Then visit: `http://conversion-guide.ltc.bcit.ca` (or use port-forward from the NOTES). -->
...
| image.repository | string | `"bcit-ltc/conversion-guide"` |  |
| image.tag | string | `"1.1.0"` |  |
| imagePullSecrets | list | `[]` |  |
| ingress.annotations | object | `{}` |  |
| ingress.create | bool | `false` |  |
| ingress.host | string | `"conversion-guide.ltc.bcit.ca"` |  |
| ingress.tlsSecret | string | `""` |  |
| name | string | `"conversion-guide"` |  |
