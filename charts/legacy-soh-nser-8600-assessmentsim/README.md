...
# legacy-soh-nser-8600-assessmentsim
...
legacy-soh-nser-8600-assessmentsim is a legacy multimedia application.

**Homepage:** <https://legacy-soh-nser-8600-assessmentsim.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/legacy-soh-nser-8600-assessmentsim/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/legacy-soh-nser-8600-assessmentsim --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install legacy-soh-nser-8600-assessmentsim .
    ```
...
| assets.ref | string | `"ghcr.io/bcit-ltc/legacy-soh-nser-8600-assessmentsim-assets"` | Reference to the asset OCI image |
...
| frontend.image.repository | string | `"bcit-ltc/legacy-soh-nser-8600-assessmentsim"` | Frontend image repository |
...
| frontend.name | string | `"legacy-soh-nser-8600-assessmentsim"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"legacy-soh-nser-8600-assessmentsim"` | Authoritative name |
...
| initContainer.image.repository | string | `"bcit-ltc/legacy-soh-nser-8600-assessmentsim"` | initContainer image repository |
| initContainer.image.tag | string | `"1.1.0"` | initContainer image tag |
