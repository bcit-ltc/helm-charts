...
legacy-soe is a legacy multimedia application.
...
| assets.ref | string | `"ghcr.io/bcit-ltc/legacy-soe-assets"` | Reference to the asset OCI image |
...
| frontend.image.repository | string | `"bcit-ltc/legacy-soe"` | Frontend image repository |
...
| frontend.name | string | `"legacy-soe"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"legacy-soe"` | Authoritative name |
...
| initContainer.image.repository | string | `"bcit-ltc/legacy-soe"` | initContainer image repository |
