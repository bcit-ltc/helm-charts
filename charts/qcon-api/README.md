...
| frontend.image.repository | string | `"bcit-ltc/qcon-api"` | Image default repository |
...
| frontend.name | string | `"qcon-api"` | The name of the frontend container to create. If empty uses "frontend" |
