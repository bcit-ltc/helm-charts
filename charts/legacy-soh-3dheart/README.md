...
| assets.ref | string | `"ghcr.io/bcit-ltc/legacy-soh-3dheart-assets"` | Reference to the asset OCI image |
...
| frontend.image.repository | string | `"bcit-ltc/legacy-soh-3dheart"` | Frontend image repository |
| frontend.image.tag | string | `"1.0.1"` | Frontend image tag |
...
| frontend.name | string | `"legacy-soh-3dheart"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"legacy-soh-3dheart"` | Authoritative name |
...
| initContainer.image.repository | string | `"bcit-ltc/legacy-soh-3dheart"` | initContainer image repository |
| initContainer.image.tag | string | `"1.0.1"` | initContainer image tag |
