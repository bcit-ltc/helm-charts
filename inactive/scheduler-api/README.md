...
**Homepage:** <https://scheduler-api.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/scheduler-api/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/scheduler-api --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install scheduler-api .
    ```
...
| frontend.image.repository | string | `"bcit-ltc/scheduler-api"` | Frontend image repository |
...
| frontend.name | string | `"scheduler-api"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"scheduler-api"` | Authoritative name |
