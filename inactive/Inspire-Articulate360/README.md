...
**Homepage:** <https://Inspire-Articulate360.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/Inspire-Articulate360/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/Inspire-Articulate360 --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install Inspire-Articulate360 .
    ```
...
| frontend.image.repository | string | `"bcit-ltc/Inspire-Articulate360"` | Frontend image repository |
...
| frontend.name | string | `"Inspire-Articulate360"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"Inspire-Articulate360"` | Authoritative name |
