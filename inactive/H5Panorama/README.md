...
**Homepage:** <https://H5Panorama.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/H5Panorama/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/H5Panorama --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install H5Panorama .
    ```
...
| frontend.image.repository | string | `"bcit-ltc/H5Panorama"` | Frontend image repository |
...
| frontend.name | string | `"H5Panorama"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"H5Panorama"` | Authoritative name |
