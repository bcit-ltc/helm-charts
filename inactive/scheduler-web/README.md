...
**Homepage:** <https://scheduler-web.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/scheduler-web/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/scheduler-web --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install scheduler-web .
    ```
...
| frontend.image.repository | string | `"bcit-ltc/scheduler-web"` | Frontend image repository |
...
| frontend.name | string | `"scheduler-web"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"scheduler-web"` | Authoritative name |
