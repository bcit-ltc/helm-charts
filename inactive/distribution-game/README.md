...
**Homepage:** <https://distribution-game.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/distribution-game/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/distribution-game --version {VERSION}
    ```

1. Install the chart:

    ```console
    helm install distribution-game .
    ```
...
| frontend.image.repository | string | `"bcit-ltc/distribution-game"` | Frontend image repository |
...
| frontend.name | string | `"distribution-game"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"distribution-game"` | Authoritative name |
