...
| frontend.image.repository | string | `"bcit-ltc/SOH_PerinatalPal"` | Frontend image repository |
...
| frontend.name | string | `"SOH_PerinatalPal"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"SOH_PerinatalPal"` | Authoritative name |
