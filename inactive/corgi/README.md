...
**Homepage:** <https://corgi.ltc.bcit.ca>
...
1. List the available registry tags
    ...
    https://api.github.com/orgs/bcit-ltc/packages/container/corgi/versions \
...
1. Pull and inspect the helm chart:
    ...
    ```console
    helm pull --untar oci://ghcr.io/bcit-ltc/corgi --version {VERSION}
    ```
...
| frontend.image.repository | string | `"bcit-ltc/corgi"` | Frontend image repository |
...
| frontend.name | string | `"corgi"` | The name of the frontend container to create. If empty uses "frontend" |
...
| global.name | string | `"corgi"` | Authoritative name |
